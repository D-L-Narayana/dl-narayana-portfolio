...
tl.to({},{duration:0.45});
tl.add('exit');
tl.to('#hello',{x:14,duration:0.06,ease:'none',yoyo:true,repeat:16},'exit');
tl.to('#hello',{rotation:2.5,duration:0.08,ease:'none',yoyo:true,repeat:12},'exit');
tl.to('#hello',{y:-window.innerHeight*1.25,opacity:0,duration:0.65,ease:'power3.in'},'exit+=0.25');
